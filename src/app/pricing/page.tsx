...
const PLANS: Plan[] = [
  ...
  },
  {
    ...
    features: [
      ...
      'Auto-invoicing for retainers',
      'Automatic lead reminders',
...
const COMPARE: { label: string; free: string | boolean; pro: string | boolean; ultra: string | boolean }[] = [
  ...
  { label: 'Team members', free: '1', pro: '5', ultra: 'Unlimited' },
  { label: 'Active leads', free: '20', pro: '200', ultra: 'Unlimited' },
  { label: 'AI quotes & contracts / month', free: '3', pro: '25', ultra: '100' },
  ...
  { label: 'Google Calendar & Meet', free: true, pro: true, ultra: true },
  { label: 'Client portal', free: '1 client', pro: 'Every client', ultra: 'Every client' },
  { label: 'Revenue analytics', free: 'Basic', pro: 'Full', ultra: 'Full' },
  { label: 'Project files & payments', free: false, pro: true, ultra: true },
  { label: 'Auto-invoicing for retainers', free: false, pro: true, ultra: true },
  { label: 'Automatic lead reminders', free: false, pro: true, ultra: true },
  { label: 'Team payroll', free: false, pro: false, ultra: true },
  { label: 'White label (your brand colour & logo)', free: false, pro: false, ultra: true },
  { label: 'Lead integrations', free: false, pro: false, ultra: true },
...
const PRICING_FAQS = [
  {
    ...
    a: 'Yes — the Free plan is free forever, with no credit card required. It includes up to 3 clients, 5 projects, 1 teammate and 20 active leads, the client portal for one client, Google Calendar sync, invoicing, meetings, and basic analytics.',
  },
  {
