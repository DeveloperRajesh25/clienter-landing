              ...
              <div className="relative z-10">
                ...
                <Reveal delay={320}>
                  <p className="mt-4 text-xs text-espresso-muted">
                    By signing up you agree to our{' '}
                    <Link href="/terms" className="font-semibold text-espresso-text hover:text-orange-400">
                      Terms
                    </Link>{' '}
                    and{' '}
                    <Link href="/privacy" className="font-semibold text-espresso-text hover:text-orange-400">
                      Privacy Notice
                    </Link>
                    .
                  </p>
