...
const CLIENT_MANAGEMENT: SeoLandingConfig = {
  ...
  ogTitle: 'Clienter — Client Management CRM Software',
  ogDescription:
  ...
  intro: {
    ...
    body: [
      ...
      'Clienter is client management software built specifically for Indian freelancers and small agencies. Every client gets one tidy profile with their full history attached: the projects you’ve run, the invoices you’ve raised, the payments you’ve collected, and the meetings you’ve had. When a client emails asking “where are we at?”, the answer is one click away.',
      'Because it’s a proper CRM and not just a contact list, Clienter also tracks the work before it becomes a client — a visual lead pipeline — and the money after — invoices, expenses, and profit — so the whole lifecycle of a client lives in one place.',
    ],
  },
  benefits: {
    heading: 'Why freelancers switch to Clienter',
  ...
  compare: {
    ...
    sub: 'Here’s what changes the day you move your clients into Clienter.',
    old: [
  ...
  faqs: [
    {
      ...
      a: 'Client management software is a tool that keeps everything about your clients — contacts, projects, invoices, payments, documents, and communication history — in one organized system instead of scattered across spreadsheets, chats, and email. Clienter is client management software (a CRM) built for freelancers and agencies, so you can run every client relationship from one place.',
    },
    {
    ...
    },
    {
      ...
      a: 'A client management system is the software and process you use to organize client relationships end to end — from the first lead, through active projects and invoices, to reviews and repeat work. Clienter is a client management system that covers all of it in one workspace.',
    },
    {
      q: 'Can I download client management software or is it online?',
      a: 'Clienter is cloud-based, so there is nothing to download or install — you sign in from any browser on your laptop or phone and your data syncs everywhere. That also means automatic backups and no software to update. You can export all your data anytime.',
    },
  ],
  related: [
    { href: '/crm-for-freelancers', label: 'CRM for Freelancers', desc: 'A sales & client CRM sized for solo freelancers.' },
    { href: '/features', label: 'All features', desc: 'Every tool Clienter gives you, in detail.' },
...
const CRM_FOR_FREELANCERS: SeoLandingConfig = {
  ...
  ogTitle: 'CRM for Freelancers — Clienter',
  ogDescription:
  ...
  subheading:
    'Most CRMs are bloated tools designed for big sales teams. Clienter is a simple, affordable CRM that tracks your leads, manages your clients, and helps you get paid — without the enterprise overwhelm.',
  intro: {
    ...
    body: [
      ...
      'A CRM for freelancers strips that down to what actually matters when you’re a team of one: a simple pipeline to move leads from “first message” to “signed”, one clean profile per client, and the invoices and payments attached right where you need them. Clienter is that CRM — lightweight enough to actually use every day, complete enough to run your whole business.',
      'Because freelancing blends sales and delivery, Clienter goes a step further than a pure CRM: the same tool that tracks your pipeline also runs your projects, raises your invoices, and collects verified reviews when you finish — so you’re never bouncing between a CRM and five other apps.',
    ],
  },
  benefits: {
    ...
    items: [
      ...
      },
      {
        ...
        desc: 'Finish a project and Clienter collects a verified review automatically — the social proof that lands bigger work.',
      },
    ],
  },
  capabilities: {
  ...
  faqs: [
    ...
    },
    {
      ...
      a: 'If you have more than a couple of clients, yes — even a simple CRM stops leads from slipping through the cracks and keeps every client’s details, projects, and payments in one place. Clienter is designed so a solo freelancer gets that benefit without enterprise complexity or cost.',
    },
    {
    ...
    },
    {
      ...
      a: 'A normal CRM stops at tracking leads and contacts. Clienter combines that pipeline with everything freelancers do after the sale — projects, GST invoices, a client portal, meetings, and verified reviews — so you run your whole business in one tool instead of a CRM plus five others.',
    },
  ],
  related: [
...
const PROJECT_MANAGEMENT_CRM: SeoLandingConfig = {
  ...
  ogTitle: 'Project Management CRM — Clienter',
  ogDescription:
  ...
  h1Highlight: 'work',
  subheading:
    'Generic project tools forget who the work is for. Clienter ties every project to its client, budget, and invoice — so you see delivery and the relationship together, on one board.',
  intro: {
    ...
    body: [
      ...
      'Clienter is a project management CRM built for Indian freelancers and agencies. You run projects on clean Kanban boards, assign your team, track budgets and deadlines, and keep clients in the loop through a branded portal — all without leaving the tool that also holds their contact details and invoices.',
    ],
  },
  benefits: {
  ...
  faqs: [
    {
      ...
      a: 'The best project management tool for a freelancer connects the work to the client and the invoice — otherwise you’re still juggling apps. Clienter gives you Kanban boards, deadlines, budgets, and tasks, all tied to the client they belong to, plus invoicing and a client portal, so delivery and the relationship live in one workspace.',
    },
    {
    ...
    },
    {
      ...
      a: 'Use a tool that links them. In Clienter, each project sits under its client, so opening a client shows all their projects, invoices, and payments, and opening a project shows the client it’s for. That single connection removes almost all the copy-pasting between apps.',
    },
    {
...
const BUSINESS_MANAGEMENT: SeoLandingConfig = {
  ...
  ogTitle: 'Business Management Software — Clienter',
  ogDescription:
  ...
  faqs: [
    ...
    },
    {
      ...
      a: 'With Clienter, you record client payments against their invoices and log project expenses as you go. The dashboard then shows total paid, outstanding dues, expenses, and net profit automatically — so you always know what you’ve earned and who still owes you, without a spreadsheet.',
    },
    {
      q: 'What is the best team management software for agencies?',
      a: 'The best team management software for a small agency ties your team to the actual client work. Clienter lets you add team members with role-based access (owner, admin, team), assign them to projects and tasks, and track what you owe each one — built into the same workspace that holds your clients and invoices.',
    },
    {
