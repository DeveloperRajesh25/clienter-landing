...
Client:     __________________________  Date: __________`,
    ...
    ctaSubtitle: 'Clienter handles proposals, e-signatures, and invoices in one place. Start free.',
...
Approve this proposal to get started. Questions? Just reply and we'll sort them out.`,
    ...
    ctaSubtitle: 'Clienter sends proposals clients accept and e-sign in their portal. Start free.',
  },
...
FIRST WEEK
  ...
  [ ] Deliver a small early win if possible`,
    ...
    ctaSubtitle: 'Clienter uses intake forms and a client portal to start projects cleanly. Start free.',
  },
...
Any change to this scope will be agreed in writing, with any impact on price and timeline stated before work continues.`,
    ...
    ctaSubtitle: 'Clienter ties scope and budgets to every project. Start free.',
  },
...
Party B: __________________________  Date: __________`,
    ...
    ctaSubtitle: 'Clienter manages proposals, agreements, and e-signatures. Start free.',
    disclaimer: LEGAL_DISCLAIMER,
  },
