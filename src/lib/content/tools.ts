...
export const TOOLS: ToolConfig[] = [
  {
    ...
    metaTitle: 'Free Invoice Generator India — Clienter',
    metaDescription:
    ...
    ctaSubtitle: 'Clienter manages clients, projects, and payments too. Start free.',
  },

  {
    ...
    ctaSubtitle: 'Clienter keeps your clients, projects, and invoices in one place. Start free.',
  },

  {
    ...
    faqs: [
      ...
      { q: 'How do I handle scope creep?', a: 'Set a written scope, quote with a contingency, and treat anything beyond it as a change order billed separately. Clienter ties budgets to projects so overruns are visible early.' },
    ],
    related: [
    ...
    ctaSubtitle: 'Clienter connects your quotes, projects, and invoices. Start free.',
  },
...

  {
    ...
    ctaSubtitle: 'Clienter tracks invoices, payments, and dues in one place. Start free.',
  },

  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          'Track margin across the business and it becomes a decision-making tool: it tells you when you can afford to hire, when to raise rates, and which clients are actually profitable. Clienter tracks income and expenses per project so this number stays live instead of being reconstructed at year-end.',
        ],
      },
    ],
    ...
    ctaSubtitle: 'Clienter tracks income and expenses per project. Start free.',
  },

  {
    ...
    ctaSubtitle: 'Clienter tracks retainer projects and recurring invoices. Start free.',
  },

  {
    ...
    sections: [
      {
        ...
        body: [
          ...
          'This generator lays out those fields in the right structure and does the tax maths for you, so your draft is correct before you finalise it. For a polished, branded PDF with your logo, use the full invoice generator or Clienter, which produces GST invoices automatically.',
        ],
      },
      {
    ...
    faqs: [
      ...
      { q: 'Can I get a branded PDF invoice?', a: 'Yes — use the full invoice generator or Clienter for a branded PDF with your logo. This tool produces a correct text draft you can copy or download for free.' },
    ],
    related: [
...

  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          'A good habit is to set a validity period on your quote so a price you gave three months ago does not come back to haunt you. When the client accepts, convert the quote into an invoice rather than retyping it — in Clienter, a quote and its invoice share the same client details automatically.',
        ],
      },
    ],
    ...
    ctaSubtitle: 'Clienter turns quotes into invoices without retyping. Start free.',
  },

  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          'End with a single, easy next step — “approve this proposal to get started” — so the client knows precisely what to do. In Clienter you can send proposals clients accept and e-sign in their portal, turning a yes into a signed agreement without printing anything.',
        ],
      },
    ],
    ...
    related: [
      ...
      { href: '/features/crm-lead-pipeline', label: 'Lead Pipeline', desc: 'Send and track proposals in Clienter.' },
    ],
    ctaTitle: 'Send proposals clients can e-sign',
    ctaSubtitle: 'Clienter turns proposals into signed deals in the portal. Start free.',
  },

  {
    ...
    ctaSubtitle: 'Clienter handles proposals, e-signatures, and invoices. Start free.',
  },

  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          'When you do need to chase, keeping track of who owes what and for how long makes it far less stressful. Clienter tracks outstanding dues so you know exactly which invoices to follow up on, instead of hunting through your inbox.',
        ],
      },
    ],
    ...
    related: [
      ...
      { href: '/features/invoicing', label: 'Invoicing', desc: 'Track dues automatically in Clienter.' },
    ],
    ctaTitle: 'Never lose track of who owes you',
    ctaSubtitle: 'Clienter tracks outstanding invoices and dues. Start free.',
  },

  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          'The one rule you cannot break is consecutiveness — never skip or reuse a number. If you cancel an invoice, keep the number in the record marked as cancelled rather than reusing it. Doing this by hand is error-prone, which is why Clienter numbers your invoices automatically and consecutively.',
        ],
      },
    ],
    ...
    related: [
      ...
      { href: '/features/invoicing', label: 'Invoicing', desc: 'Automatic numbering in Clienter.' },
    ],
    ctaTitle: 'Let your invoices number themselves',
    ctaSubtitle: 'Clienter handles consecutive, GST-safe invoice numbers. Start free.',
  },

  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          'Retyping hours from a timesheet into an invoice is exactly the kind of admin that eats freelance evenings. In Clienter, billable work ties to projects and flows into invoices, so the hours you track become the invoice you send without copying anything twice.',
        ],
      },
    ],
    ...
    faqs: [
      ...
      { q: 'How do I turn a timesheet into an invoice?', a: 'Total the billable hours, multiply by your rate, and that’s your invoice line. Keep the timesheet as the record behind the bill. Clienter ties billable work to invoices so you don’t retype it.' },
    ...
    related: [
      ...
      { href: '/features/project-management', label: 'Project Management', desc: 'Tie hours to projects in Clienter.' },
    ],
    ctaTitle: 'Track once, invoice automatically',
    ctaSubtitle: 'Clienter turns tracked work into invoices. Start free.',
  },
]
...
TOOLS.push({
  ...
  metaTitle: 'Time Zone Converter — Clienter',
  ...
  ctaSubtitle: 'Clienter syncs meetings with Google Calendar and Meet. Start free.',
})
