...
export const CLIENTER_VS_DUBSADO: ComparePageConfig = {
  ...
  clienterCons: [
    ...
    'Less suited to engineering intricate, fully hands-off client workflows',
  ],
  competitorPros: [
    'Deep, powerful workflow automation for hands-off client management',
    'Excellent, highly customizable form and questionnaire builder',
    'Mature suite with contracts, invoicing, scheduling, and a client portal',
    'Strong fit for US creatives who want to automate their whole process',
  ],
  competitorCons: [
