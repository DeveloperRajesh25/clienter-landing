...
export const CLIENTER_VS_SPREADSHEETS: ComparePageConfig = {
  slug: 'clienter-vs-spreadsheets',
  path: '/compare/clienter-vs-spreadsheets',
  competitor: 'spreadsheets',
  competitorCategory: 'manual Excel / Google Sheets',
  metaTitle: 'Spreadsheet Alternative for Freelancers | Clienter',
  metaDescription:
    'Still running your freelance business on spreadsheets? See how Clienter compares to Excel and Google Sheets for clients, projects, and GST invoices.',
  keywords: [
    'spreadsheet alternative for freelancers',
    'clienter vs spreadsheets',
    'excel alternative for freelancers',
    'google sheets crm alternative',
  ],
  ogTitle: 'Clienter vs spreadsheets — the honest comparison',
  ogDescription:
    'Spreadsheets are free and flexible, but manual and fragile. See how Clienter compares for freelancers managing clients, projects, and invoices.',
  breadcrumbLabel: 'Clienter vs Spreadsheets',
  eyebrow: 'Clienter vs Spreadsheets',
  h1: 'Clienter vs Spreadsheets: the honest',
  h1Highlight: 'comparison',
  subheading:
    'Almost every freelancer starts in a spreadsheet — it’s free, familiar, and endlessly flexible. But as clients pile up, all that manual work starts to cost you. Here’s an honest look at spreadsheets vs Clienter.',
  intro: {
    heading: 'The tool everyone starts with — and when it stops keeping up',
    body: [
  ...
  rows: [
    { feature: 'Built for', clienter: 'Freelancers & agencies managing clients', other: 'Anything — but nothing in particular' },
  ...
  clienterCons: [
    'Not free beyond the Free plan’s limits, unlike a blank sheet',
    'Less freeform than a spreadsheet if you love fully custom layouts',
    'A new tool to learn, versus a spreadsheet you already know',
  ],
  competitorPros: [
    'Free and already on almost every computer',
    'Endlessly flexible — arrange it however you like',
    'Familiar; nearly everyone knows the basics',
    'Great for quick, one-off calculations and simple lists',
  ],
  competitorCons: [
  ...
  chooseOther: {
    heading: 'Stick with spreadsheets if you…',
    points: [
      'Are just starting out with only one or two clients',
      'Truly can’t spend anything and need zero cost',
      'Love a fully custom, freeform layout you control completely',
      'Only need simple lists and one-off calculations',
    ],
  },
  migration: {
  ...
  faqHeading: 'Clienter vs spreadsheets FAQs',
  faqs: [
    {
      q: 'Is Clienter better than a spreadsheet for freelancers?',
      a: 'Once you have more than a couple of clients, usually yes. A spreadsheet is free and flexible but entirely manual — no reminders, no GST invoicing, no client portal, and no safety net if a formula breaks. Clienter keeps the simplicity but automates the admin, and it starts free so you can try it without leaving your budget.',
    },
    {
      q: 'Can Clienter import my existing spreadsheet?',
      a: 'You can move your data over easily. Export your client sheet as a CSV and recreate your active clients and leads in Clienter — for most freelancers that’s a short, one-afternoon job because you’re only carrying over active relationships, not years of history. After that, invoices, payments, and projects live in Clienter instead of in cells.',
    },
    {
