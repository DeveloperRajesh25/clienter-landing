                ...
                className={
                  editorial
                    ? `font-display text-lg font-bold tracking-tight transition-colors duration-300 sm:text-xl ${
                        isOpen ? 'text-orange-700' : 'text-gray-900 group-hover/faq:text-orange-700'
                      }`
                ...
                className={`flex flex-none items-center justify-center rounded-full border transition-all duration-300 ${
                  ...
                  isOpen
                    ? dark
                      ...
                      : 'rotate-45 border-orange-500/30 bg-orange-500 text-white'
                    : dark
                      ? 'border-white/10 text-stone-400'
                      : editorial
                        ? 'border-line text-stone-400 group-hover/faq:border-orange-300 group-hover/faq:text-orange-600'
