...
export function GlowCard({
  ...
  return (
    <div
      ...
      className={`group/glow relative h-full overflow-hidden border border-stone-200/80 bg-white shadow-soft transition-all duration-300 hover:-translate-y-0.5 hover:border-orange-200 hover:shadow-soft-lg ${className}`}
    >
      <div
        aria-hidden
