...
function EditableText({
  ...
  return (
    <Tag
      ...
      className={`cursor-text rounded px-1 -mx-1 transition-colors hover:bg-orange-50/70 hover:ring-1 hover:ring-orange-200 ${className} ${isPlaceholder ? 'text-slate-300 italic' : ''}`}
      title="Click to edit"
    >
      {display}
    </Tag>
...
/**
 * The actual invoice document — same layout as Clienter's in-app invoice PDF.
    ...
    >
      <div className="flex-1 p-14">
        ...
        <div className="flex items-start justify-between">
          <div id="pdf-logo-link" className="flex items-center">
            ...
            <img src="/logo.png" alt="Clienter logo" width={48} height={48} className="h-12 w-12" />
            <div className="ml-3">
        ...
        <div className="mt-7 flex items-start justify-between">
          <div>
            <p className="text-[11px] font-bold uppercase tracking-wider text-orange-600">From</p>
        ...
        {/* Bill to */}
        <div className="mt-7">
          <p className="text-[11px] font-bold uppercase tracking-wider text-orange-600">Bill To</p>
          <div className="mt-2 text-[15px] font-bold text-slate-900">
        ...
        {(data.projectName || interactive) && (
          <div className="mt-7 rounded-r-md border-l-4 border-orange-500 bg-amber-50 px-5 py-3">
        ...
        {interactive && onAddItem && (
          <button
            type="button"
            onClick={onAddItem}
            className="mt-2 inline-flex items-center gap-1 text-[12px] font-semibold text-orange-500 hover:text-orange-600 transition-colors"
          >
        ...
        <div className="mt-4 flex justify-end">
          <div className="w-64">
            ...
            <div className="mt-2 flex items-center justify-between rounded-md bg-orange-600 px-4 py-3">
        ...
        {interactive && onAddSection && (
          <button
            ...
            className="mt-6 inline-flex items-center gap-1.5 text-[12px] font-semibold text-orange-500 hover:text-orange-600 transition-colors rounded-lg border border-dashed border-orange-200 hover:border-orange-400 px-3 py-2 hover:bg-orange-50/50"
          >
      ...
      <div className="mt-auto">
        <div id="pdf-footer-link" className="pb-6 text-center">
          <p className="text-[12px] font-semibold text-slate-400">Generated via Clienter</p>
