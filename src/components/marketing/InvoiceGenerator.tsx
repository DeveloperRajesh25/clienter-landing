...
const inputClass =
  'h-9 w-full rounded-lg border border-gray-200 bg-white px-3 text-sm text-gray-900 shadow-sm transition-all placeholder:text-gray-400 focus:border-orange-500 focus:outline-none focus:ring-2 focus:ring-orange-500/20 disabled:opacity-60'
    ...
    try {
      ...
      const addPdfLink = (elementId: string) => {
        ...
        if (linkPageIndex <= pdf.getNumberOfPages()) {
          ...
          pdf.link(xMm, pageYMm, wMm, hMm, { url: 'https://clienter.co.in' })
        }
      }
        ...
        <div className="space-y-3 lg:max-h-[calc(100vh-10rem)] lg:overflow-y-auto lg:pr-1 no-scrollbar">
          ...
          <div className="rounded-xl border border-gray-100 bg-white p-4 shadow-sm">
            ...
            <button
              type="button"
              onClick={addItem}
              className="press mt-2 inline-flex items-center gap-1.5 text-xs font-semibold text-orange-600 hover:text-orange-700"
            >
              ...
              <div className="mt-2.5 space-y-2">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={2}
                    className="w-full rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm text-gray-900 shadow-sm transition-all placeholder:text-gray-400 focus:border-orange-500 focus:outline-none focus:ring-2 focus:ring-orange-500/20"
          ...
          <div className="rounded-xl border border-gray-100 bg-white p-4 shadow-sm">
            ...
            <textarea
              ...
              rows={2}
              className="mt-2.5 w-full rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm text-gray-900 shadow-sm transition-all placeholder:text-gray-400 focus:border-orange-500 focus:outline-none focus:ring-2 focus:ring-orange-500/20"
              value={invoice.notes}
          ...
          <button
            type="button"
            onClick={addSection}
            className="press w-full inline-flex items-center justify-center gap-1.5 rounded-xl border-2 border-dashed border-gray-200 bg-white/50 py-2.5 text-xs font-semibold text-gray-500 transition-all hover:border-orange-300 hover:text-orange-600 hover:bg-orange-50/30"
          >
