        ...
        <div className="flex flex-wrap gap-2">
          <button
            ...
            className={`rounded-full px-3.5 py-1.5 text-sm font-medium transition-colors ${
              active === 'all' ? 'bg-gray-900 text-white' : 'border border-stone-200 bg-white text-gray-600 hover:text-orange-600'
            }`}
          >
            All
          </button>
          {categories.map((c) => (
            <button
              ...
              className={`rounded-full px-3.5 py-1.5 text-sm font-medium transition-colors ${
                active === c.slug ? 'bg-gray-900 text-white' : 'border border-stone-200 bg-white text-gray-600 hover:text-orange-600'
              }`}
            >
              {c.name}
            </button>
