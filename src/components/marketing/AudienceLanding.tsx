            ...
            {workflow.steps.map(({ title, desc }, i) => (
              <Reveal key={title} delay={i * 60}>
                <li className="flex gap-5 rounded-2xl border border-stone-200/70 bg-white/60 p-6 shadow-soft backdrop-blur-sm">
                  <span className="flex h-10 w-10 flex-none items-center justify-center rounded-xl bg-gradient-to-br from-orange-500 to-amber-500 font-display text-lg font-bold text-white shadow-lg shadow-orange-500/25">
                    {i + 1}
                  </span>
                  <div>
      ...
      <section className="py-16 sm:py-24">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          <Reveal>
            ...
            <Link
              href="/pricing"
              className="mt-8 inline-flex items-center gap-1.5 font-semibold text-orange-600 hover:text-orange-700"
            >
              See full pricing
