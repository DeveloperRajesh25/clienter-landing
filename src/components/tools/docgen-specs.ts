...
export const DOCGEN_SPECS: Record<string, DocGenSpec> = {
  'quotation-generator': {
    ...
    note: 'For a branded PDF quote or a GST tax invoice, use Clienter or the invoice generator.',
  },
  ...
  'gst-invoice-generator': {
    ...
    note: 'A GST invoice draft to copy or print. For a branded PDF with your logo, use the full invoice generator or Clienter. Confirm the correct GST rate (HSN/SAC) for your service.',
  },
  ...
  'proposal-template-generator': {
    ...
    note: 'A starting proposal you can copy and refine. In Clienter you can send proposals clients accept and e-sign in their portal.',
  },
  ...
  'late-payment-reminder-generator': {
    ...
    note: 'Type “firm” in the tone field for a stronger follow-up. Clienter can track dues and remind you who to chase.',
  },
  ...
  'invoice-number-generator': {
    ...
    note: 'GST rules require a consecutive, unique invoice number series. Clienter numbers your invoices automatically.',
  },
  ...
  'timesheet-generator': {
    ...
    note: 'A simple copyable timesheet. Clienter ties billable work to projects and invoices so you don’t retype it.',
  },
}
